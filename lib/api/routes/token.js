...
module.exports = function(app){
    ...
    app.get(routePrefix + '/token', [app.logger('default'), app.methodOverride(), app.json(), app.urlencoded(), setHeaders, middleware.authorization, token.get]);
    app.get(routePrefix + '/token/new', [app.logger('default'), app.methodOverride(), app.json(), app.urlencoded(), setHeaders, middleware.authorization, middleware.authToken, token.getNew]);
    app.get(routePrefix + '/token/logout', [app.logger('default'), app.methodOverride(), app.json(), app.urlencoded(), setHeaders, middleware.authorization, middleware.authToken, token.deleteById]);
