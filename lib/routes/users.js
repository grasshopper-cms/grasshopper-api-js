module.exports = function(app){
    ...
    app.get('/users', [middleware.authorization, middleware.authToken, user.getList]);
    app.get('/user', [middleware.authorization, middleware.authToken, user.getCurrentUser]);
    app.get('/users/:id', [middleware.authorization, middleware.authToken, user.getById]);

    app.put('/users', [middleware.authorization, middleware.authToken, user.update]);
    app.put('/user', [middleware.authorization, middleware.authToken, user.update]);
    app.put('/users/:id', [middleware.authorization, middleware.authToken, user.update]);

    app.post('/users/:id/permissions', [middleware.authorization, middleware.authToken, user.updatePermission]);
    app.post('/users', [middleware.authorization, middleware.authToken, user.create]);
    app.post('/users/query', [middleware.authorization, middleware.authToken, user.query]);

    app.delete('/users/:id', [middleware.authorization, middleware.authToken, user.deleteById]);
    app.delete('/users/:id/permissions/:nodeid', [middleware.authorization, middleware.authToken, user.deletePermission]);
