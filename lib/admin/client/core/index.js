...
// This is the heart of the front end. It dynamically loads the plugins needed.
var appState = require('app-state').init(),
    ...
    // recreateElementsScriptTags = require('recreate-elements-script-tags'),
...
function startHistory() {
    window.gh.util.location
        ...
        .onParamsChange(function(locationObject) {
            console.log('Params Changed ', locationObject.search);
        })
...
// This make an api request to get the chunk of HTML to be rendered into #stage
function renderView(pathName) {

    const src = router.match(pathName);
    ...
    //
    //             recreateElementsScriptTags($stage)
    //                 .then(function() {
