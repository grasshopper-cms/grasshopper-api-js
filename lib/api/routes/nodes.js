(function(){
    ...
    node.getChildNodesAndContent = function(httpRequest, httpResponse){
        ...
        // This is necessary because this method gets called with at least 3 arguments
        args.push(GET_CONTENT);
        node.getChildNodes.apply(this, args);
    }
    ...
    node.getChildNodes = function(httpRequest, httpResponse){
        ...
        function iterateChildren(obj){
            async.each(obj, addAllowedNodes,
                GET_CONTENT === lastArgument ? doneAndGetContent : done);
        }
