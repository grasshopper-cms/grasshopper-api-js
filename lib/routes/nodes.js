module.exports = function(app){
    ...
    app.delete(routePrefix + '/node/:nodeid/assets/:filename', [middleware.authorization, middleware.authToken, cleanNodeId, node.deleteAsset]);
    app.delete(routePrefix + '/node/:nodeid/assets', [middleware.authorization, middleware.authToken, cleanNodeId, node.deleteAllAssets]);
    app.delete(routePrefix + '/node/:nodeid', [middleware.authorization, middleware.authToken, cleanNodeId, node.deleteNodeById]);
