        ...
        .then(function(plugins) {
            return BB.all(plugins
                    .map(function(plugin) {
                        ...
                        try {
                            fs.statSync(path.join(grasshopper.instance.state.projectRootPath, 'plugins', plugin.fields.directory, 'activate')).isFile();
                            ...
                            return runThisPluginsActivateSequense(path.join(__dirname, '..', plugin.fields.directory, 'activate'), grasshopper.instance);
                        }
