...
module.exports = function(app){
    ...
    app.get('/token/logout', [authorize, authenticate, routes.token.deleteById]);
    ...
    app.get('/node/:nodeid/children', [authorize, authenticate, cleanNodeId, setParentOfNode, permissionsByNode.requireReader, routes.nodes.getChildNodes]);
    app.get('/node/:nodeid/hydrate', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireReader, routes.nodes.getChildNodesAndContent]);
    app.get('/node/:nodeid/children/deep', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireReader, routes.nodes.getChildNodesDeep]);
    app.get('/node/:nodeid/assets/deep', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.getAssetsDeep]);
    app.get('/node/:nodeid/deep', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireReader, routes.nodes.getByIdDeep]);
    app.get('/node/:nodeid/assets', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireReader, routes.nodes.getAssets]);
    app.get('/node/:nodeid/assets/:filename', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireReader, routes.nodes.getAsset]);
    app.post('/node/:nodeid/assets/copy', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.copyAsset]);
    app.post('/node/:nodeid/assets/move', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.moveAsset]);
    app.post('/node/:nodeid/assets/rename', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.renameAsset]);
    app.del('/node/:nodeid/assets/:filename', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.deleteAsset]);
    app.del('/node/:nodeid/assets', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.deleteAllAssets]);
    app.post('/node/:nodeid/assets',[authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.attachAsset]);
    app.get('/node/:nodeid', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireReader, routes.nodes.getById]);
    app.put('/node/:nodeid', [authorize, authenticate, cleanNodeId,  dehydrateRequestBody, setParentOfNode, permissionsByNode.requireEditor, routes.nodes.update]);
    app.del('/node/:nodeid', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.deleteNodeById]);

    app.post('/node', [authorize, authenticate, cleanNodeId, dehydrateRequestBody, setParentOfNode, permissionsByNode.requireEditor, routes.nodes.create]);
    app.post('/node/:nodeid/contenttype', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.addContentTypes]);
    app.post('/nodes', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.create]);
