module.exports = function(router){
    ...
    api.getBySlug = function (httpRequest, httpResponse){
        var promise = grasshopper.request(httpRequest.bridgetown.token).content
            .query({
                filters:{
                    key: 'slug',
                    cmp: '=',
    ...
    router.route('/content/slug/:slug')
        .get([middleware.authorization, middleware.authToken, api.getBySlug]);
