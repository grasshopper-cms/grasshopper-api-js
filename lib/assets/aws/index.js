module.exports = (function(){
    ...
    internal.putObject = function(nodeid, filename, callback){
        var path = path.join(internal.config.tmpdir, filename),
            self = this;
    ...
    engine.save = function(nodeid, filename, callback){
        internal.putObject(nodeid, filename, callback);
    };
