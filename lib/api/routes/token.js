...
module.exports = function(app){
    ...
    app.get(routePrefix + '/token', [express.logger('default'), express.methodOverride(), express.json(), express.urlencoded(), setHeaders, middleware.authorization, token.get]);
    app.get(routePrefix + '/token/new', [express.logger('default'), express.methodOverride(), express.json(), express.urlencoded(), setHeaders, middleware.authorization, middleware.authToken, token.getNew]);
    app.get(routePrefix + '/token/logout', [express.logger('default'), express.methodOverride(), express.json(), express.urlencoded(), setHeaders, middleware.authorization, middleware.authToken, token.deleteById]);
