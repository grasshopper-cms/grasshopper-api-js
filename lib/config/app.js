...
var app = function(config){
    ...
    app.log = log;
    app.cache = require('../utils/cache')(config.cache);
    app.db = require('../db/database')(config.db);
    app.crypto = require('../utils/crypto')(config.crypto);
    app.tokens = require('../entities/tokens')(app.crypto);
