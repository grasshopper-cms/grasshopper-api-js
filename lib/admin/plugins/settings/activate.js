...
module.exports = function activatePluginsPlugin() {
    ...
    grasshopper.instance.admin.get('/settings', grasshopper.instance.renderAdminRoot);
    grasshopper.instance.admin.get('/settings/html/:partialName', require('./index').getPartialMiddleware);
