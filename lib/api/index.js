...
module.exports = function(app){
    ...
    app.get('/node/:nodeid/hydrate', [authorize, authenticate, setParentOfNode, permissionsByNode.requireReader, routes.nodes.getChildNodesAndContent]);
    ...
    //// TODO: Travis please review the following line.
    app.get('/node/:nodeid/assets/:filename', [authorize, authenticate, setParentOfNode, permissionsByNode.requireReader, routes.nodes.getAsset]);
    ...
    // TODO: Couldn't this be a PUT to /node/:nodeid/assets/:filename ... this would clean up the Backbone Code allot.
    ...
    app.put('/node/:nodeid', [authorize, authenticate, setParentOfNode, permissionsByNode.requireEditor, routes.nodes.update]);
