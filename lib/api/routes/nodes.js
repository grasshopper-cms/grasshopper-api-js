module.exports = function(app){
    ...
    app.get(routePrefix + '/node/:nodeid/children',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid/hydrate',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid/content',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
            .add(Builder.node.required.reader)
            .add(node.getNodesContent).middleware
    );

    app.get(routePrefix + '/node/:nodeid/children/deep',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid/assets/deep',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid/deep',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid/assets',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid/assets/:filename',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.post(routePrefix + '/node/:nodeid/assets/copy',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.post(routePrefix + '/node/:nodeid/assets/move',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.post(routePrefix + '/node/:nodeid/assets/rename',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.del(routePrefix + '/node/:nodeid/assets/:filename',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.del(routePrefix + '/node/:nodeid/assets',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.post(routePrefix + '/node/:nodeid/assets',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.get(routePrefix + '/node/:nodeid',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.put(routePrefix + '/node/:nodeid',
        new Builder()
            .secure()
            .add(cleanNodeId)
    ...
    app.del(routePrefix + '/node/:nodeid',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
    ...
    app.post(routePrefix + '/node/:nodeid/contenttype',
        new Builder()
            .secure()
            .add(cleanNodeId)
            .add(setParentOfNode)
