module.exports = function(app){
    ...
    node.getById = function(id, callback){
        internal.app.db.nodes.getById(id, callback);
    };

    node.getBySlug = function(slug, callback){
        internal.app.db.nodes.getBySlug(slug, callback);
    };
    ...
    node.getChildNodes = function(id, recurrsive, callback){
        internal.app.db.nodes.getByParent(id, function(err, nodes){
            callback(err, nodes);
        });
    };
    ...
    node.getFiles = function(nodeid, callback){
        internal.app.assets.list(nodeid, callback);
    };
    ...
    node.deleteById = function(id, callback){
        internal.app.db.nodes.deleteById(id, callback);
    };
    ...
    node.update = function(obj, callback){
        internal.app.db.nodes.update(obj, callback);
    };
