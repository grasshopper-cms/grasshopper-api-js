module.exports = function(app){
    ...
    user.updatePermission = function(httpRequest, httpResponse){
        var promise = grasshopper.request(httpRequest.bridgetown.token).users.savePermissions(httpRequest.params.id, httpRequest.body);
        writeApiResponse(httpResponse, promise);
    };
    ...
    user.query = function (httpRequest, httpResponse){
        var promise = grasshopper.request(httpRequest.bridgetown.token).users.query(httpRequest.body.filters,httpRequest.body.options);
        writeApiResponse(httpResponse, promise);
    };
