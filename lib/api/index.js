...
module.exports = function(app){
    ...
    app.put('/node/:nodeid', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.update]);
    ...
    app.post('/node', [authorize, authenticate, cleanNodeId,  setParentOfNode, permissionsByNode.requireEditor, routes.nodes.create]);
