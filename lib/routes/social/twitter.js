...
// Twitter social linking/registration module
module.exports = function(app){
    app.get('/connect/twitter/done', twitter);
};
...
function _createSocialAccount(){
    return grasshopper.auth('Twitter', this.params)
                .then(function(token) {
...
function _linkIdentity() {
    ...
    return grasshopper.request(this.token).users.linkIdentity(this.user._id.toString(), 'twitter', identityOptions);
}
