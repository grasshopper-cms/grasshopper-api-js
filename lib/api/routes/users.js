module.exports = function(app){
    ...
    app.get(routePrefix + '/users',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.getList).middleware
    );

    app.get(routePrefix + '/user',
        new Builder()
            .secure()
            .add(user.getCurrentUser).middleware
    );

    app.get(routePrefix + '/users/:id',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.getById).middleware
    );

    app.put(routePrefix + '/users',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.update).middleware
    );

    app.put(routePrefix + '/user',
        new Builder()
            .secure(Builder.user.required.adminOrSelf)
            .add(user.update).middleware
    );

    app.put(routePrefix + '/users/:id',
        new Builder()
            .secure(Builder.user.required.adminOrSelf)
            .add(user.update).middleware
    );

    app.post(routePrefix + '/users/:id/permissions',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.updatePermission).middleware
    );

    app.post(routePrefix + '/users',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.create).middleware
    );

    app.post(routePrefix + '/users/query',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.query).middleware
    );

    app.delete(routePrefix + '/users/:id',
        new Builder()
            .secure(Builder.user.required.admin)
            .add(user.deleteById).middleware
    );

    app.delete(routePrefix + '/users/:id/permissions/:nodeid',
        new Builder()
            .secure(Builder.user.required.admin)
