...
var _ = require('lodash'),
    ...
    admin = require('grasshopper-admin'),
    fs = require('fs'),
    http = require('http'),
    https = require('https'),
 ...
 *
 * @param options - Express app that you want to use to act as a proxy to the grasshopper api
 */
module.exports = function(options){

    var grasshopper = require('grasshopper-core').init(options),
