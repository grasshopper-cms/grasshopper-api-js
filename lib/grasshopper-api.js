...
module.exports = function(options){
    ...
    ghapiRouter.use(express.static(__dirname + '/routes/admin/_base'));
    ...
    require('./routes/admin/content-types/route')(ghapiRouter);
    require('./routes/admin/forbidden/route')(ghapiRouter);
    require('./routes/admin/help/route')(ghapiRouter);
    require('./routes/admin/items/route')(ghapiRouter);
    require('./routes/admin/item/route')(ghapiRouter);
    require('./routes/admin/login/route')(ghapiRouter);
    require('./routes/admin/logout/route')(ghapiRouter);
    require('./routes/admin/sys-info/route')(ghapiRouter);
    require('./routes/admin/users/route')(ghapiRouter);
    require('./routes/admin/user/route')(ghapiRouter);

    //For redirect URL of your OAuth application always use this format:
    //[protocol]://[host]/connect/[provider]/callback
    ghapiRouter.use(session({ secret:grasshopper.config.crypto.secret_passphrase }));
