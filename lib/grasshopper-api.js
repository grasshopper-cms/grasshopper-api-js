...
module.exports = function(options){
    ...
    var fs = require('fs'),
        ...
        // TODO: is this Grant always necessary? should not create if not needed
        grant = new Grant({
            server: {
    ...
    function initialize() {
        ...
        adminRouter.get('*', function(req, res) {
            res.render(path.join(__dirname, 'admin', 'admin.pug'));
        });
        // Add static assets last, so they can be overriden
        return adminRouter;
    }

    return {
        admin : initialize(options),
        core : grasshopper,
